      ...
      <div className="z-10 flex justify-center items-center">
        <div className=" bg-blue-300 my-10 flex flex-col p-5 gap-3" >
          ...
          <span className="flex gap-2 justify-between">
            <button className="cursor-pointer hover:scale-110 duration-200 transition bg-red-300 rounded-sm p-2" onClick={onClose}>Cancelar</button>
            <button className="cursor-pointer hover:scale-110 duration-200 transition bg-green-300 p-2 rounded-sm min-w-20" onClick={updateInfos}>Salvar</button>
          </span>
        </div>
      </div>
    </div>
